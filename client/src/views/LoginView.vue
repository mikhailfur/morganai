  ...
  <div class="min-h-screen flex items-center justify-center px-6 py-12 relative z-10">
    <div class="w-full max-w-[420px]">
      ...
      <Card variant="raised" padding="none"
        ...
        <h1 class="font-bold text-2xl tracking-[-0.02em] text-[var(--fg)]">С возвращением</h1>
        <p class="text-sm text-[var(--fg-muted)] mt-1.5 mb-6">Она помнит, на чём вы остановились.</p>
        ...
        <form @submit.prevent="handleLogin" class="flex flex-col gap-4">
          ...
          <div class="flex items-center justify-between gap-2">
            <label class="flex items-center gap-2 text-[13px] text-[var(--fg-muted)] cursor-pointer">
              <input type="checkbox" v-model="remember" class="accent-violet-600 size-4" />
              <span>Запомнить меня</span>
            </label>
            <span class="text-[13px] text-[var(--accent-soft)] cursor-pointer hover:underline">
              Забыли пароль?
            </span>
          </div>
