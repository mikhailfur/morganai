...
async function initGoogleButton() {
  ...
  } catch { /* GSI load error, button stays as-is */ }
}
  ...
  <div style="width: 100%; min-height: 100vh; display: flex; background: var(--bg); color: var(--fg);">
    ...
    ">
      ...
      <div style="margin-top: 16px; display: grid; grid-template-columns: 1fr 1fr; gap: 10px;" class="animate-fade-in-3">
        ...
        <div style="position: relative; overflow: hidden; min-height: 44px;">
          <button class="btn-ghost" style="width: 100%; height: 44px; padding: 12px; pointer-events: none; display: flex; align-items: center; justify-content: center; gap: 8px;">
