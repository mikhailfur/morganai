...
const landingQuote = ref(
    landingQuotes[Math.floor(Math.random() * landingQuotes.length)],
);
    ...
    <div class="min-h-screen" style="background: var(--bg); color: var(--fg)">
        ...
        <nav class="landing-nav">
            <div style="display: flex; align-items: center; gap: 10px">
                <img
                    src="/logo.png"
                    alt="Morgan"
                    style="height: 40px; border-radius: 6px; display: block"
                />
                <span
                    style="
            ...
            <div class="landing-nav-links">
                <router-link to="/pricing" class="nav-text-link"
                    >Тарифы</router-link
                >
                <router-link to="/legal" class="nav-text-link"
                ...
                <router-link
                    to="/login"
                    class="btn-ghost btn-sm nav-login-btn"
            ...
            >
                ...
                >
                    ...
                    <span style="opacity: 0.8"
                        >Бесплатно. 50 сообщений в день.</span
                    >
                </div>
            </div>
            <div
        ...
        <section class="features">
            <div
                ...
                style="color: var(--accent2); margin-bottom: 20px"
            >
            ...
            >
                <div
                    ...
                    :key="f.title"
                    class="feature-card"
                    :style="{ borderLeft: i === 0 ? 'var(--border)' : 'none' }"
                >
                    <div
                        style="
                            font-family: var(--font-display);
            ...
            features: [
                {
                    icon: "言",
                    title: "Ролевой чат",
                    desc: "Глубокие диалоги с уникальными AI-персонажами с памятью и характером.",
                },
                {
                    icon: "声",
                    title: "Голосовые",
                    desc: "Слышь живой голос персонажа — MiniMax TTS. Автовоспроизведение.",
                },
                {
                    icon: "眼",
                    title: "Фото",
                    desc: "Отправляй изображения — персонаж видит и реагирует.",
                },
                {
                    icon: "心",
                    title: "Режимы",
                    desc: "Учёба, работа, психолог и NSFW (18+) — выбери контекст.",
                },
            ],
        };
    },
